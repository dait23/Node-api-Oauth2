...
var setRouter = function (router) {
    ...
    router.post(RestApi + 'wish',
        ...
        function (req, res) {
            ...
            newWish.interest = req.body.interest;
        ...
        function (req, res) {
            Wish.findOne({
                ...
                if (req.user.id !== wish.userId) {
                    ...
                    //wish.interest = req.body.content;
