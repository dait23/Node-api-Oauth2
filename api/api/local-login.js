...
var setRouter = function (router) {
    ...
    router.post(RestApi + 'auth/login',  function (req, res, next) {
    ...
    router.get(RestApi + 'auth/logout', function (req, res) {
    ...
    router.post(RestApi + 'auth/signup', function (req, res, next) {
