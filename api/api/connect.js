...
router.post(RestApi + 'connect/local',
...
router.get(RestApi + 'disconnect/local',
        passport.authenticate('bearer', { session: false }),
        oauth2Server.error(),
        function (req, res) {
...
router.get(RestApi + 'connect/:socialapp',
        function (req, res, next) {
...
router.get(RestApi + 'disconnect/:socialapp',
        passport.authenticate('bearer', { session: false }),
        oauth2Server.error(),
        function (req, res) {
            var user = req.user;
