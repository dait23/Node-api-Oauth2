...
var setRouter = function (router) {
    ...
    router.get(RestApi + 'oauth2/authorize', isLogined, oauth2Server.authorize());
    router.post(RestApi + 'oauth2/authorize/decision', isLogined, oauth2Server.decision());
    ...
    router.post(RestApi + 'oauth2/token',
    ...
    router.del(RestApi + 'oauth2/token',
    ...
    router.get(RestApi + 'oauth2/authorize/callback', function (req, res) {
