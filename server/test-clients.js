...
var trustedClient2Info = {
    name: 'For_Website',
    grantType: [
      predefine.oauth2.type.password.name,
      predefine.oauth2.type.password.token_refreshable
    ],
    clientId: 'kdksdkandiiein883',
...
module.exports = function () {
    ...
    OauthClient.findOne({
        ...
        if (trustedClient === null) {
            trustedClient = new OauthClient();
            trustedClient.name = trustedClient2Info.name;
            trustedClient.grantType = trustedClient2Info.grantType;
            trustedClient.clientId = trustedClient2Info.clientId;
            trustedClient.clientSecret = trustedClient2Info.clientSecret;
